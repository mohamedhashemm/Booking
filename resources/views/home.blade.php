        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start"
                ...
                <div class="col-md-7 ftco-animate">
                    ...
                    <p><a href="#" class="btn btn-primary">Learn more</a> <a href="{{route('contact')}}"
                ...
                @foreach ($hotels as $hotel)
                    <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
                        <div class="d-block services-wrap text-center">
                            <div class="img"
                                style="background-image: url('{{ asset('assets/images/'. $hotel->image. '') }}');"></div>
                        ...
                        <div class="room-wrap d-md-flex">
                            ...
                            <div class="half left-arrow d-flex align-items-center">
                                <div class="text p-4 p-xl-5 text-center">
                                    ...
                                    <h3 class="mb-3"><a href="{{route('hotel.room.details',$room->id)}}">{{ $room->name }}</a></h3>
                                    <ul class="list-accomodation">
                                        <li><span>Max:</span> {{ $room->max_persons }}</li>
                                        <li><span>Size:</span>{{ $room->size }}</li>
                                        <li><span>View:</span> {{ $room->view }}</li>
                                        <li><span>Bed:</span> {{ $room->num_beds }}</li>
                                    </ul>
                                    <p class="pt-1"><a href="{{route('hotel.room.details',$room->id)}}" class="btn-custom px-3 py-2">View Room
