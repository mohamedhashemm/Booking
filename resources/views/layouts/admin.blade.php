                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    @auth('admin')
                        <ul class="navbar-nav side-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('admins.alladmins')}}" style="margin-left: 20px;">Admins</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('hotel.all')}}"
                                    style="margin-left: 20px;">Hotels</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('all.rooms')}}" style="margin-left: 20px;">Rooms</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-md-auto d-md-flex">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('admin.viewlogin')}}">login
                                </a>
                            </li>
                        @endauth
